...
@interface AppointmentsListViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
-(void)LoadAppointmentsList
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/appointments/%@/%@",preURL,[[NSUserDefaults standardUserDefaults] stringForKey:@"userId"],[[NSUserDefaults standardUserDefaults] stringForKey:@"videoId"]]];
